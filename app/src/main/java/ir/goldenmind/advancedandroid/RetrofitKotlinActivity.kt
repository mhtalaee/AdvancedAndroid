...
import ir.goldenmind.advancedandroid.retrofit.IMDBRequestInterfaceKotlin
import ir.goldenmind.advancedandroid.retrofit.RetrofitServiceGenerator
import ir.goldenmind.advancedandroid.retrofit.RetrofitServiceGeneratorKotlin
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnGetMovieInfo.setOnClickListener {
            ...
            var imdbRequestInterface =
                RetrofitServiceGeneratorKotlin.createService(IMDBRequestInterfaceKotlin::class.java)
            imdbRequestInterface.getMovieInfo(etMovieName.text.toString(), Consts.API_KEY)
                .enqueue(object : retrofit2.Callback<IMDBResponse> {
                    ...
                    override fun onFailure(call: Call<IMDBResponse>, t: Throwable) {
                        Toast.makeText(this@RetrofitKotlinActivity, "Error fetching movie info", Toast.LENGTH_SHORT)
                            .show();
                    }
                })
        }
